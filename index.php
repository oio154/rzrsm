...
<head>
    ...
    <link href="css/main.css?<?= $rand ?>" rel="stylesheet">
    ...
    <body>
        <div class="hd-part1">
        <img src="./img/path4147-1059.png" alt="header" class="hd-image" />
        <img src="./img/zwiazek_BT.png" alt="logo" class="hd-image-logo" />
            <div class="hd-div-right">Regionalny Związek Rewizyjny Spółdzielczości Mieszkaniowej <span class="nobr">w Katowicach</span></div>
    </div>
    <div class="hd-part2">
        <ul class="menu-ul">
            <li class="menu-li"><a href="#">O Związku Rewizyjnym</a></li>
            <li class="menu-li"><a href="#">Prawo i dokumenty</a></li>
            <li class="menu-li"><a href="#">Menu link 3</a></li>
            <li class="menu-li"><a href="#">Menu link 4</a></li>
            <li class="menu-li"><a href="#">Menu link 5</a></li>
    ...
    <div class="news">
        ...
        <div class="news-one"><img class="news-image" src="http://lorempixel.com/162/166/" />plsp</div>
        <div class="news-one"><img class="news-image" src="http://lorempixel.com/166/165/" />oosk</div>
        <div class="news-one"><img class="news-image" src="http://lorempixel.com/165/162/" />odoo</div>
...
https://unsplash.it/500/300/?random
